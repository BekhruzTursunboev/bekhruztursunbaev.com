...
export const ui = {
  ...
  uz: {
    ...
    toolkitLead: "Foizli shkalalar yo’q — faqat real loyihalarda ishlatganlarim.",
    about: "Men haqimda",
    aboutHeadA: "Toshkentdan",
    aboutHeadAccent: "Kunshanga",
    aboutHeadB: ".",
    aboutLead: "Dasturlashni boshlaganimning sababi — menga kerakli narsalar o’zbek tilida yo’q edi.",
    aboutBody: "Keyingi loyihalarim ham shunday paydo bo’ldi: jadvallarga ko’milib qolgan rieltorlar, repetitorga pul topa olmaydigan o’quvchilar va uy narxini bilmaydigan xaridorlar uchun. Toshkentda to’rt yil ishlaganimdan keyin hozir 1-kurs talabasiman — {school}. Full-stack yo’nalishini tanladim, chunki kichik jamoada hamma narsani qila bilish kerak.",
    aboutJudo: "Dzyudo bilan ham shug’ullanaman: ikki marta tuman chempioni bo’lganman.",
    education: "Ta’lim",
    languages: "Tillar",
    workAuth: "Ishlash huquqi bo’yicha savolingiz bo’lsa, yozing — aniq javob beraman.",
    colophon: "Sayt haqida",
    colophonBody: "Sayt framework’siz, qo’lda yozilgan va Node skripti bilan yig’iladi. Animatsiyalar faqat CSS’da, shuning uchun sahifa JavaScript’siz ham to’liq ochiladi. Manba kodi ochiq. Shriftlar {selfHosted}, chunki Google Fonts Xitoyda ochilmaydi, o’quvchilarimning yarmi esa shu yerda.",
